...
const center = document.getElementById('become');
...
center.addEventListener('click',()=>go(center.dataset.target));
center.addEventListener('keydown',e=>{ if(e.key==='Enter'||e.key===' ') { e.preventDefault(); center.click(); } });
reactor.addEventListener('click',()=>go(center.dataset.target));
